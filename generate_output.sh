...
echo "Executing julia and mandelbrot..."
...
C-JuliaSets/julia -0.1 0.1 -0.1 0.1 1920 1920 -1.037 0.17 > juliaset.csv
Cpp-Mandelbrot/mandelbrot -0.1 0.1 -0.1 0.1 1920 1920 > mandelbrot.csv 